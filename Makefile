...
# Template: app
# Command: D:\Qt\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile MMDO_l1_ultimate_vuvid.pro
#############################################################################
...
Makefile: MMDO_l1_ultimate_vuvid.pro ../Qt/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf ../Qt/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug" -o Makefile MMDO_l1_ultimate_vuvid.pro
